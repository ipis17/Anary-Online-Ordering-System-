...
<div class="row">
  <div class="col-lg-10 col-lg-offset-1 col-md-8 col-md-offset-2">
    <div class="well">
        ...
        }else if(isset($_POST['select_service'])&&isset($_POST['select_location'])) { // code for !isset$_POST['select_product'];
          ...
          if($select_location == ''){
            //echo "<script>console.log('you select nothing!')</script>";
            $stmt = $pdo->query("
          ...
          while($row_dropdown = $stmt->fetch(PDO::FETCH_ASSOC)){ 
            ...
            //echo "<script>console.log('nice you input both!')</script>";
            $stmt = $pdo->query("
          ...
          while($row_location = $stmt->fetch(PDO::FETCH_ASSOC)){ 
              ...
              <div class="col-lg-3">
              <div class="well">
              <img style="width: 100%;height: 150px;" data-toggle="modal" data-target="#<?php echo $row_location["ID"]; ?>" src="partner/product_image/<?php echo $row_location['productImage'] ?>" class="img-responsive"><center>
        ...
        // else if(isset($_POST['select_location'])){
        //   $select_location = $_POST['select_location'];
        //   echo "<script>console.log('you select: ".$select_location." ')</script>";
        // }
          ?>
