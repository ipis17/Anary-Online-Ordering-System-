...
<div class="container">
  <div class="row">
    <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="row">
          <form action="guestProduct.php" method="POST">
            <div class="col-lg-4">
          ...
          <div class="col-lg-5 col-md-5 col-sm-5">
            <div class="form-group">
              <select class="form-control" name="select_product">
                ...
                <option value="loothbag">Loot Bag</option>
...
<div class="row">
  <div class="col-lg-10 col-lg-offset-1 col-md-8 col-md-offset-2">
    <div class="well">
          ...
          WHERE tbl_partner.approve = 1 and category = 'products'
        ...
        }else if(isset($_POST['select_product'])&&isset($_POST['select_location'])) { // code for !isset$_POST['select_product'];
          ...
          if($select_location == ''){
            //pag walang ininput na loction, mag select all sya
            $stmt = $pdo->query("
          SELECT tbl_products.product_image as productImage, tbl_products.id as ID, tbl_products.product_name as productName, tbl_products.price as productPrice, tbl_products.type as productType, tbl_products.product_details as productDetails, tbl_products.partner_id as partnerID FROM tbl_products LEFT JOIN tbl_partner ON tbl_products.partner_id = tbl_partner.id WHERE tbl_partner.approve = 1 AND category = 'products' AND tbl_products.type LIKE '%$select_product%' ");
            ...
            $stmt = $pdo->query("
          SELECT tbl_products.product_image as productImage, tbl_products.id as ID, tbl_products.product_name as productName, tbl_products.price as productPrice, tbl_products.type as productType, tbl_products.product_details as productDetails, tbl_products.partner_id as partnerID FROM tbl_products LEFT JOIN tbl_partner ON tbl_products.partner_id = tbl_partner.id WHERE tbl_partner.approve = 1 AND category = 'products' AND tbl_products.type LIKE '%$select_product%' AND tbl_partner.city_address LIKE '%$select_location%' ");
...
$sql_insert = 'INSERT INTO tbl_message(email, message) VALUES(:email, :message)';
                    ...
                    if($stmt->rowCount()) {
                        echo "<script> alert('Message Sent'); window.location.href='guestProduct.php#contact'; </script> ";
