...
<div class="container">
  <div class="row">
    <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="row">
          <form action="memberProduct.php" method="POST">
            <div class="col-lg-4">
...
<div class="row">
  <div class="col-lg-10 col-lg-offset-1 col-md-8 col-md-offset-2">
    <div class="well">
        ...
        }else if(isset($_POST['select_product'])&&isset($_POST['select_location'])){
...
$sql_insert = 'INSERT INTO tbl_message(email, message) VALUES(:email, :message)';
                    ...
                    if($stmt->rowCount()) {
                        echo "<script> alert('Message Sent'); window.location.href='memberProduct.php#contact'; </script> ";
    ...
    ?>
        ...
        <div class="row">
            ...
            <div class="col-md-4 footer-about">
                ...
                <form action="memeberProduct.php" method="POST">
