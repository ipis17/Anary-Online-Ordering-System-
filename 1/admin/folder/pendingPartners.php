                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $stmt = $pdo->query("SELECT * FROM tbl_partner WHERE approve = 0 ");
                                while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    echo "</td><td><center><a href='evaluate_partner.php?id=".$row['id']."' class='btn btn-info btn-sm'>Evaluate</a></center>";
                                    echo "</td></td>";
                                }
                            ?>
                         </tbody>
